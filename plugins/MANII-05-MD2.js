...
try{
let desc = `🌟 *GOOD ${new Date().getHours() < 12 ? '𝐌𝐎𝐑𝐍𝐈𝐍𝐆' : '𝐍𝐈𝐆𝐇𝐓'}, ${pushname}!* 🌟
...
const vv = await conn.sendMessage(from, { 
  ...
  contextInfo: { 
    ...
    forwardedNewsletterMessageInfo: { 
      ...
      newsletterName: "𝐌𝐀𝐍𝐈𝐈-𝟎𝟓-𝐌𝐃 𝐌𝐄𝐍𝐔", 
      serverMessageId: 999 
    }, 
    externalAdReply: { 
      title: '𝗠𝗔𝗡𝗜𝗜-𝟬𝟱-𝗠𝗗', 
      body: `${pushname}`, 
      mediaType: 1,                                                  
      sourceUrl: "https://whatsapp.com/channel/0029VbDXEsMKrWQyjdNioe1H", 
...
await conn.sendMessage(from, { image: { url:config.ALIVE_IMG}, caption: owner2,
        ...
        isForwarded: true,
        forwardedNewsletterMessageInfo: {
          newsletterJid: '120363406014910137@newsletterr',
          newsletterName: '𝗠𝗔𝗡𝗜𝗜-𝟬𝟱-𝗠𝗗',
          serverMessageId: 143
        }
      }
