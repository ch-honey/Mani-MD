...
const { setCommitHash, getCommitHash } = require('../mani05/MANII-05-MD');
...
cmd({
    ...
    try {
        await reply("*_🔍 CHECKING UPDATES FOR MANII-05-MD..🚀_*");
        ...
        if (latestCommitHash === currentHash) {
            return reply("*_✅ MANII-05-MD IS ALREADY UP-TO-DATE...🚀_*");
        }

        await reply("*_🌐 UPDATING MANII-05-MD PLEASE WAIT...🚀_*");
        ...
        const sourcePath = path.join(extractPath, "MANII-05-MD-main");
