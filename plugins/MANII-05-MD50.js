...
cmd({
  ...
  'react': '🔊',
  'filename': __filename
}, async (_0x43450d, _0xa1496d, _0x483377, {
  from: _0x28631c,
  quoted: _0x1f860a,
  body: _0x3a7c3a,
  isCmd: _0x7cc2c4,
  ...
  isGroup: _0x4a39fe,
  sender: _0x3d92b2,
  senderNumber: _0x312169,
  botNumber2: _0x5d8396,
  botNumber: _0x4a1a73,
  pushname: _0x3f3db4,
  isMe: _0x57bf4c,
  isOwner: _0x2f081c,
  groupMetadata: _0x51f0ca,
  groupName: _0x3bae37,
  participants: _0x4f08f3,
  groupAdmins: _0x804b38,
  isBotAdmins: _0x31ff81,
  isAdmins: _0x1051b0,
  reply: _0x49ddee
}) => {
  try {
    if (!_0x33a6a0) {
      return _0x49ddee("Please provide text for conversion! Usage: `.tts <text>`");
    }
    let _0x3bdd02 = "en-US";
    let _0x54eb6d = "male";
    if (_0x40bf5f[0] === "male") {
      ...
      if (_0x40bf5f[0] === "female") {
        _0x3bdd02 = "en-GB";
        _0x54eb6d = "female";
      } else {
        if (_0x40bf5f[0] === "loud") {
          _0x3bdd02 = "en-US";
        } else if (_0x40bf5f[0] === "deep") {
          _0x3bdd02 = "en-US";
        } else {
          _0x3bdd02 = "en-US";
        }
    ...
    const _0x2753dd = googleTTS.getAudioUrl(_0x33a6a0, {
      'lang': _0x3bdd02,
      'slow': false,
      'host': "https://translate.google.com"
    });
    await _0x43450d.sendMessage(_0x28631c, {
      'audio': {
        'url': _0x2753dd
      },
      'mimetype': "audio/mpeg",
    ...
    console.error(_0x54dacd);
    _0x49ddee("Error: " + _0x54dacd.message);
  }
});
cmd({
  'pattern': "tts4",
  ...
  'react': '🔊',
  'filename': __filename
}, async (_0x42f8fd, _0xa7fb29, _0x4fc4f2, {
  from: _0x27a024,
  quoted: _0x1f67fd,
  body: _0x28df37,
  isCmd: _0x139032,
  ...
  isGroup: _0x20d5d6,
  sender: _0x50072a,
  senderNumber: _0x56ded6,
  botNumber2: _0xe0ef9f,
  botNumber: _0x5e76c7,
  pushname: _0x45a0eb,
  isMe: _0x2711dd,
  isOwner: _0x2d0b60,
  groupMetadata: _0x3602e7,
  groupName: _0x21f2df,
  participants: _0xd5091d,
  groupAdmins: _0x2b41ad,
  isBotAdmins: _0x1d2dff,
  isAdmins: _0x5aa019,
  reply: _0x29b541
}) => {
  try {
    if (!_0x1a88bf) {
      return _0x29b541("Please provide text for conversion! Usage: `.tts2 <text>`");
    }
    let _0x423851 = "en-US";
    if (_0x2f861c[0] === 'ur' || _0x2f861c[0] === "urdu") {
      _0x423851 = 'ur';
    }
    const _0xe04c15 = googleTTS.getAudioUrl(_0x1a88bf, {
      'lang': _0x423851,
      'slow': false,
      'host': "https://translate.google.com"
    });
    await _0x42f8fd.sendMessage(_0x27a024, {
      'audio': {
        'url': _0xe04c15
      },
      'mimetype': "audio/mpeg",
    ...
    console.error(_0x590f1d);
    _0x29b541("Error: " + _0x590f1d.message);
  }
});
const {
  sleep
...
cmd({
  ...
  try {
    ...
    _0x526f68("🎨 *`MANII-05-MD RANDOM COLOUR:`* \n\nColour Name: " + _0x140f13 + "\nCode: " + _0x44ef3a);
  } catch (_0x1116ab) {
...
cmd({
  ...
  try {
    ...
    _0x3292b7(" *`MANII-05-MD BINARY REPRESENTATION:`* \n\n" + _0x52f4fd);
  } catch (_0x5e3d86) {
...
cmd({
  ...
  try {
    ...
    _0x2f1c72("*`MANII-05-MD KERM DECODED TEXT:`* \n\n" + _0x51228e);
  } catch (_0x2c1976) {
...
cmd({
  ...
  try {
    ...
    _0x7740d3(" *MANII-05-MD ENCODED URL TEXT:* \n" + _0x516aac);
  } catch (_0x247bf9) {
...
cmd({
  ...
  'category': "owner",
  'filename': __filename
}, async (_0x1d14b3, _0x1a2919, _0x26ef01, {
  args: _0x4990f0,
  reply: _0x37701d,
  senderNumber: _0x220909
}) => {
  try {
    const _0x30ebea = _0x1d14b3.user.id.split(':')[0];
    if (_0x220909 !== _0x30ebea) {
      return _0x37701d("❎ Only the bot owner can use this command.");
    }
    if (!_0x4990f0[0]) {
      return _0x37701d("✳️ Use this command like:\n *Example:* .countx 10");
    }
    const _0x4b72cf = parseInt(_0x4990f0[0].trim());
    if (isNaN(_0x4b72cf) || _0x4b72cf <= 0 || _0x4b72cf > 50) {
      return _0x37701d("❎ Please specify a valid number between 1 and 50.");
    }
    _0x37701d("⏳ Starting reverse countdown from " + _0x4b72cf + "...");
    for (let _0x38d58c = _0x4b72cf; _0x38d58c >= 1; _0x38d58c--) {
      await _0x1d14b3.sendMessage(_0x26ef01.chat, {
        'text': '' + _0x38d58c
      }, {
        'quoted': _0x1a2919
      });
    ...
    _0x37701d("✅ Countdown completed.");
  } catch (_0x310870) {
    console.error(_0x310870);
    _0x37701d("❎ An error occurred while processing your request.");
  }
});
cmd({
  'pattern': "count",
  ...
  'category': "owner",
  'filename': __filename
}, async (_0x24bd31, _0xa1cb96, _0x2429d4, {
  args: _0x4cfae4,
  reply: _0x2ace24,
  senderNumber: _0x3fe7e1
}) => {
  try {
    const _0x43bb3b = _0x24bd31.user.id.split(':')[0];
    if (_0x3fe7e1 !== _0x43bb3b) {
      return _0x2ace24("❎ Only the bot owner can use this command.");
    }
    if (!_0x4cfae4[0]) {
      return _0x2ace24("✳️ Use this command like:\n *Example:* .count 10");
    }
    const _0x1d96f1 = parseInt(_0x4cfae4[0].trim());
    if (isNaN(_0x1d96f1) || _0x1d96f1 <= 0 || _0x1d96f1 > 50) {
      return _0x2ace24("❎ Please specify a valid number between 1 and 50.");
    }
    _0x2ace24("⏳ Starting countdown to " + _0x1d96f1 + "...");
    for (let _0x302f96 = 1; _0x302f96 <= _0x1d96f1; _0x302f96++) {
      await _0x24bd31.sendMessage(_0x2429d4.chat, {
        'text': '' + _0x302f96
      }, {
        'quoted': _0xa1cb96
      });
    ...
    _0x2ace24("✅ Countdown completed.");
  } catch (_0x4265b2) {
    console.error(_0x4265b2);
    _0x2ace24("❎ An error occurred while processing your request.");
  }
});
cmd({
  'pattern': "calculate",
