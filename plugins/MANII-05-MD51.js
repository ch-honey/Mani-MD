...
const { setCommitHash, getCommitHash } = require('../manii05/MANII-05-MD');
...
const toggleSettings = [
  ...
  { pattern: "auto_downloading", key: "AUTO_DOWNLOADING" },
  ...
  { pattern: "inbox_block", key: "INBOX_BLOCK" },
...
toggleSettings.forEach(item => {
  cmd({
    ...
    await reply(`*DATABASE UPDATE ${item.key} IS NOW ${status.toUpperCase()} ✅*`);
  });
});
